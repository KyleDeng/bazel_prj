...
.PHONY: xmake_static xmake_shared xmake_executable
...
define build-executable
	...
	#echo "LDFLAGS: $(LDFLAGS) $(SHARED_LDFLAGS)"
	mkdir -p $(dir $(1))
	echo "CXX -o $(1) -Wl,--start-group $(2) -Wl,--end-group $(LDFLAGS) $(XMAKE_EXECUTABLE_LDFLAGS) $(PRIVATE_LDFLAGS)"
	$(CXX) -o $(1) -Wl,--start-group $(2) -Wl,--end-group $(LDFLAGS) $(XMAKE_EXECUTABLE_LDFLAGS) $(PRIVATE_LDFLAGS)
	echo "$(1) build done."
	echo "------------------------------"
endef
...
define build-cxx-object
	...
	$(CXX) $(CXXFLAGS) $(3) -MM $(2) > $(1).d_temp
	echo -n $(dir $(1)) > $(addsuffix .d, $(1))
	cat $(1).d_temp >> $(addsuffix .d, $(1))
endef
